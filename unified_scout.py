...
class UnifiedScout:
    ...
    def run_full_scout(self, lat, lon, text_description=None, url=None, pdf_url=None):
        print("\n==================================================")
        print("\U0001F30D INITIATING GRAND UNIFICATION SCOUT")
        print("==================================================")
        ...
        if "NO-GO" in verdict:
            ...
            print("\U0001F6D1 ABORTING Phase 2 (Evaluation) to save API calls and time.")
        ...
        try:
            print("[1/4] Analyzing Terrain & Access...")
            print("[2/4] Fetching Solar & Wind Data...")
            print("[3/4] Checking Soil & Aquifers...")
            print("[4/4] Analyzing Planning Policy...")
